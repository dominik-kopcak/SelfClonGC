...
plot_name <- paste("Figure_Mutation_accumulation_selfing_vs_cloning_", h_coefficient, ".png",sep="")
ggsave(filename=plot_name,
	plot=Plot,
	dpi=600)

plot_name_2 <- paste("Figure_Mutation_accumulation_selfing_vs_cloning_", h_coefficient, "v2.png",sep="")
