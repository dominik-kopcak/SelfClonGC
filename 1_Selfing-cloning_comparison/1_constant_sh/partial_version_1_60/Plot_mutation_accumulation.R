...
replicate_number=20
colours <- c("Cloning"="darkolivegreen")
...
Plot_recessive <- ggplot()+
	...
	scale_x_continuous(breaks=c(0.95, 0.99, 1))
...
plot_name <- paste("Figure_Mutation_accumulation_cloning_60000_", h_coefficient, ".png",sep="")
