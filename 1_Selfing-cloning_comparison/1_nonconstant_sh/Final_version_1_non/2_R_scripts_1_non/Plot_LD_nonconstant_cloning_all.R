...
LD_data_0 <- read.csv("Data_nonconstant_cloning0_.csv")
LD_data_02 <- read.csv("Data_nonconstant_cloning0.2_.csv")
LD_data_04 <- read.csv("Data_nonconstant_cloning0.4_.csv")
LD_data_06 <- read.csv("Data_nonconstant_cloning0.6_.csv")
LD_data_08 <- read.csv("Data_nonconstant_cloning0.8_.csv")
LD_data_095 <- read.csv("Data_nonconstant_cloning0.95_.csv")
LD_data_099 <- read.csv("Data_nonconstant_cloning0.99_.csv")
LD_data_1 <- read.csv("Data_nonconstant_cloning1_.csv")
