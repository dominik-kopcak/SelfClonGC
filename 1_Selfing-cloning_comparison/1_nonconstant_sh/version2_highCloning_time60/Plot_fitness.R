...
Fitness_cloning <- read.csv("Data_fitness_evolution_cloning_60000.csv")
...
plot_mean_cloning_name <- paste("Figure_mean_fitness_cloning_nonconstant_sh_60000.png", sep="")
ggsave(filename = plot_mean_cloning_name,
plot = Plot_mean_cloning,
dpi = 600)

plot_variance_cloning_name <- paste("Figure_variance_fitness_cloning_nonconstant_sh_60000.png", sep="")
