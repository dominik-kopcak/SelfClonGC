...
setwd("./lambda_100/extra_small_GC_rate")
...
write.csv(Fixed_mutations_stat_GC, file="Data_GC_fixed_mutations_lambda100_extra_small.csv")
write.csv(Additive_load_stat_GC, file="Data_GC_additive_load_lambda100_extra_small.csv")
write.csv(Recessive_load_stat_GC, file="Data_GC_recessive_load_lambda100_extra_small.csv")
