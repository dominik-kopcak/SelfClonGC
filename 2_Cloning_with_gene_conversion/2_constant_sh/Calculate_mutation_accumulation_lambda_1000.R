...
write.csv(Fixed_mutations_stat_GC, file="Data_GC_fixed_mutations_lambda1000.csv")
write.csv(Additive_load_stat_GC, file="Data_GC_additive_load_lambda1000.csv")
write.csv(Recessive_load_stat_GC, file="Data_GC_recessive_load_lambda1000.csv")
