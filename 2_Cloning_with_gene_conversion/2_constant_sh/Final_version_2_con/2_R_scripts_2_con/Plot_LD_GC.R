...
LD_data_05 <- read.csv("Data_LD_GC_1e-05.csv")
LD_data_06 <- read.csv("Data_LD_GC_1e-06.csv")
LD_data_07 <- read.csv("Data_LD_GC_1e-07.csv")
LD_data_08 <- read.csv("Data_LD_GC_1e-08.csv")
LD_data_09 <- read.csv("Data_LD_GC_1e-09.csv")
LD_data_10 <- read.csv("Data_LD_GC_1e-10.csv")
LD_data_11 <- read.csv("Data_LD_GC_1e-11.csv")
