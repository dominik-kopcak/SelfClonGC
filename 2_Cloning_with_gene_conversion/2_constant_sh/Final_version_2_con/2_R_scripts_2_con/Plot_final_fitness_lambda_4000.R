...
Fitness_GC_A <- read.csv("Data_fitness_evolution_GC_vXII_full_60_5-8.csv")
Fitness_GC_B <- read.csv("Data_fitness_evolution_GC_vXII_full_60_9-11.csv")
Fitness_GC <- rbind(Fitness_GC_A, Fitness_GC_B)
...
plot_mean_GC_name_final <- paste("Figure_final_mean_fitness_GC_", h_coefficient, "_vXII_full_60.png", sep="")
