...
Fitness_GC <- read.csv("Data_fitness_evolution_GC_vXII_full.csv")
...
plot_mean_GC_name <- paste("Figure_mean_fitness_GC_", h_coefficient, "_vXII_full.png", sep="")
ggsave(filename = plot_mean_GC_name,
	plot = Plot_mean_GC,
	dpi = 600)

plot_variance_GC_name <- paste("Figure_variance_fitness_GC_", h_coefficient, "_vXII_full.png", sep="")
