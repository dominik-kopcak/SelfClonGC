...
GC_recessive_load <- read.csv("Data_GC_recessive_load_vXII_full.csv")
GC_additive_load <- read.csv("Data_GC_additive_load_vXII_full.csv")
...
plot_name <- paste("Figure_Mutation_accumulation_GC_", h_coefficient, "_vXII_full.png",sep="")
