...
write.csv(Fixed_mutations_stat_GC, file="Data_GC_fixed_mutations_vXII_test.csv")
write.csv(Additive_load_stat_GC, file="Data_GC_additive_load_vXII_test.csv")
write.csv(Recessive_load_stat_GC, file="Data_GC_recessive_load_vXII_test.csv")
write.csv(Recessive_load_GC, file="Data_GC_recessive_load_vXII_test_full.csv")
