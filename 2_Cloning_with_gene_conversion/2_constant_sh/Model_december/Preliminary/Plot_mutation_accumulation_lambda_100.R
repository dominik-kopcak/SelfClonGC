...
GC_recessive_load <- read.csv("Data_GC_recessive_load_vXII_test.csv")
GC_additive_load <- read.csv("Data_GC_additive_load_vXII_test.csv")
GC_fixed_mutations <- read.csv("Data_GC_fixed_mutations_vXII_test.csv")
...
plot_name <- paste("Figure_Mutation_accumulation_GC_", h_coefficient, "_vXII_test.png",sep="")
