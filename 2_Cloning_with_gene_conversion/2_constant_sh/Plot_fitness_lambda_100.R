...
#Fitness_GC_1 <- read.csv("Data_fitness_evolution_GC.csv")
#Fitness_GC_1$GC_rate <- as.factor(Fitness_GC_1$GC_rate)

#Fitness_GC_extra_small <- read.csv("Data_fitness_evolution_GC_extra_small.csv")
#Fitness_GC_extra_small$GC_rate <- as.factor(Fitness_GC_extra_small$GC_rate)


#Fitness_GC_list <- list(Fitness_GC_1, Fitness_GC_extra_small)      
#Fitness_GC <- Reduce(function(x, y) merge(x, y, all=TRUE), Fitness_GC_list)  
...
plot_mean_GC_name <- paste("Figure_mean_fitness_GC_", h_coefficient, ".png", sep="")
ggsave(filename = plot_mean_GC_name,
	plot = Plot_mean_GC,
	dpi = 600)

plot_variance_GC_name <- paste("Figure_variance_fitness_GC_", h_coefficient, ".png", sep="")
