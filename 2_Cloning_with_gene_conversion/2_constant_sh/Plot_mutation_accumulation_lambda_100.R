...
GC_recessive_load <- read.csv("Data_GC_recessive_load.csv")
GC_additive_load <- read.csv("Data_GC_additive_load.csv")
GC_fixed_mutations <- read.csv("Data_GC_fixed_mutations.csv")

GC_recessive_load_small <- read.csv("Data_GC_recessive_load_lambda100_extra_small.csv")
GC_additive_load_small <- read.csv("Data_GC_additive_load_lambda100_extra_small.csv")
GC_fixed_mutations_small <- read.csv("Data_GC_fixed_mutations_lambda100_extra_small.csv")

GC_recessive_load_all <- bind_rows(GC_recessive_load, GC_recessive_load_small)
GC_additive_load_all <- bind_rows(GC_additive_load, GC_additive_load_small)
GC_fixed_mutations_all <- bind_rows(GC_fixed_mutations, GC_fixed_mutations_small)
...
Plot_recessive <- ggplot()+
	...
	labs(y="Homozygous genotypes",
	 ...
	 theme(panel.grid.major=element_blank(),
  	...
  	scale_x_log10(breaks=c(10**seq(-13, -4, 2)))
