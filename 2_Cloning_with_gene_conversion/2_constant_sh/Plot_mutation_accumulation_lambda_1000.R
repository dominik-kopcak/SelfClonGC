...
GC_recessive_load_all <- read.csv("Data_GC_recessive_load_lambda1000.csv")
GC_additive_load_all <- read.csv("Data_GC_additive_load_lambda1000.csv")
GC_fixed_mutations_all <- read.csv("Data_GC_fixed_mutations_lambda1000.csv")
...
Plot_recessive <- ggplot()+
	...
	labs(y="Homozygous genotypes",
	 ...
	 theme(panel.grid.major=element_blank(),
  	...
  	scale_x_log10(breaks=c(10**seq(-11, -5, 2)))
