...
Replicate <- rep(rep(rep_temp, each = Max_time), times = N_gamma_values*N_lambda_values)
...
write.csv(Fitness_GC_stat, file="Data_fitness_evolution_GC_nonconstant_sh_60000.csv")
