...
Plot_mean_ <- ggplot() +
			 geom_line(data=fitness_cloning_GC_09, aes(x=Time, y=Expected_mean_fitness, colour = "Complete cloning + Mean GC rate per site 1E-09")) +
			 ...
			 geom_line(data=fitness_cloning_GC_10, aes(x=Time, y=Expected_mean_fitness, colour = "Complete cloning + Mean GC rate per site 1E-10")) +
			 ...
			 geom_line(data=fitness_cloning_GC_11, aes(x=Time, y=Expected_mean_fitness, colour = "Complete cloning + Mean GC rate per site 1E-11")) +
...
Plot_variance_ <- ggplot() +
			     geom_line(data=fitness_cloning_GC_09, aes(x=Time, y=Expected_variance_fitness*1000, colour = "Complete cloning + Mean GC rate per site 1E-09"))+
			     geom_ribbon(data=fitness_cloning_GC_09, aes(x=Time, ymin=(Expected_variance_fitness - 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, ymax=(Expected_variance_fitness + 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, fill = "Complete cloning + Mean GC rate per site 1E-09"), alpha = 0.5) +
			     
			     geom_line(data=fitness_cloning_GC_10, aes(x=Time, y=Expected_variance_fitness*1000, colour = "Complete cloning + Mean GC rate per site 1E-10"))+
			     geom_ribbon(data=fitness_cloning_GC_10, aes(x=Time, ymin=(Expected_variance_fitness - 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, ymax=(Expected_variance_fitness + 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, fill = "Complete cloning + Mean GC rate per site 1E-10"), alpha = 0.5) +
			     
			     geom_line(data=fitness_cloning_GC_11, aes(x=Time, y=Expected_variance_fitness*1000, colour = "Complete cloning + Mean GC rate per site 1E-11"))+
			     geom_ribbon(data=fitness_cloning_GC_11, aes(x=Time, ymin=(Expected_variance_fitness - 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, ymax=(Expected_variance_fitness + 1.96*SD_variance_fitness/sqrt(N_replicates))*1000, fill = "Complete cloning + Mean GC rate per site 1E-11"), alpha = 0.5) +
...
Plot_mean_ <- Plot_mean_ +
	...
	scale_colour_manual(values = colours, labels=c("Complete cloning                              ", 
							...
							expression(paste("Complete asex. + GC rate ", 4 %*% 10 ^ -7)), 
							expression(paste("Complete asex. + GC rate ", 4 %*% 10 ^ -8)))) +
