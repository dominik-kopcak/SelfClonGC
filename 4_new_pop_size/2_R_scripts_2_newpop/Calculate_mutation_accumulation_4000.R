...
setwd("/mnt/loki/hartfield/AsexMuts/scripts/SelfClonGC/4_new_pop_size/3_data_newpop/")
...
write.csv(Additive_load_stat_GC, file="../4_plots/Data_GC_additive_load_vXII_full_60000_newpop.csv")
write.csv(Recessive_load_stat_GC, file="../4_plots/Data_GC_recessive_load_vXII_full_60000_newpop.csv")
write.csv(Relative_homozygosity_stat_GC, file="../4_plots/Data_GC_relative_homozygosity_vXII_full_60000_newpop.csv")

write.csv(Additive_load_GC, file="../4_plots/Data_GC_additive_load_vXII_full_60000_raw_newpop.csv")
write.csv(Recessive_load_GC, file="../4_plots/Data_GC_recessive_load_vXII_full_60000_raw_newpop.csv")
write.csv(Relative_homozygosity_GC, file="../4_plots/Data_GC_relative_homozygosity_vXII_full_60000_raw_newpop.csv")
