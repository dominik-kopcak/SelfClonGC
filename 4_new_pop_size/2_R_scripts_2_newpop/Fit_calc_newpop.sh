...
#SBATCH --job-name=FitCalc_largeN    # Job name
...
Rscript Calculate_fitness_lambda_4000_newpop.R
Rscript Plot_fitness_lambda_4000.R

Rscript Calculate_mutation_accumulation_4000.R
Rscript Plot_mutation_accumulation_lambda_4000.R
