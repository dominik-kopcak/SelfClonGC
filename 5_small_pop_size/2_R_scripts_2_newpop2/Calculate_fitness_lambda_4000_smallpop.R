# Modified to calculate fitness values from small-pop sims
library(dplyr)
...
write.csv(Fitness_GC_stat, file="../4_plots/Data_fitness_evolution_GC_vXII_full_60_5-11_smallpop.csv")
