...
Mean_fitness_list_GC <- list.files(pattern="Wm_")[grep(list.files(pattern="Wm_"),pattern="_noevol",invert=F)]
Variance_fitness_list_GC <- list.files(pattern="Wv_")[grep(list.files(pattern="Wv_"),pattern="_noevol",invert=F)]
...
write.csv(Fitness_GC_stat, file="Data_fitness_evolution_GC_noevol.csv")
