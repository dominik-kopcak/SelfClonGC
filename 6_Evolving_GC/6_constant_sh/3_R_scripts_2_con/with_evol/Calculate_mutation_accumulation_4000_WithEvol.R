...
Segregating_mutations_list_GC <- list.files(pattern="X_Sampled_individuals*")[grep(list.files(pattern="X_Sampled_individuals*"),pattern="_noevol",invert=T)]
...
write.csv(Additive_load_stat_GC, file="Data_GC_additive_load_WithEvol.csv")
write.csv(Recessive_load_stat_GC, file="Data_GC_recessive_load_WithEvol.csv")
write.csv(Relative_homozygosity_stat_GC, file="Data_GC_relative_homozygosity_WithEvol.csv")

write.csv(Additive_load_GC, file="Data_GC_additive_load_WithEvol_raw.csv")
write.csv(Recessive_load_GC, file="Data_GC_recessive_load_WithEvol_raw.csv")
write.csv(Relative_homozygosity_GC, file="Data_GC_relative_homozygosity_WithEvol_raw.csv")
