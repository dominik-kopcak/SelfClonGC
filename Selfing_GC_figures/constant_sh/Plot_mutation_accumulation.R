...
colours <- c("Selfing"="darkolivegreen2","GC_1E-5"="red", "GC_1E-6"="orange")
...
Plot_recessive <- ggplot()+
	...
	geom_linerange(data = filename_rec_selfing, 
 	...
 	geom_hline(data=filename_rec_cloning_5, aes(yintercept=Expected_recessive_load), colour = "red")+
#	geom_linerange(data=filename_rec_cloning, 
#			aes(x=GC_rate, 
#			    ymax=Cloning_rec_max, 
#			    ymin=Cloning_rec_min), color="darkolivegreen", size=1)+#
	
	geom_hline(data=filename_rec_cloning_6, aes(yintercept=Expected_recessive_load), colour = "orange")+
#	geom_linerange(data=filename_rec_cloning, 
#			aes(x=GC_rate, 
#			    ymax=Cloning_rec_max, 
#			    ymin=Cloning_rec_min), color="darkolivegreen", size=1)+
...
Plot_additive <- ggplot()+
	...
	geom_hline(data=filename_add_cloning_5, aes(yintercept=Expected_additive_load/1000, colour = "GC_1E-5"))+
...
#			key_glyph = draw_key_rect)+
	...
	geom_hline(data=filename_add_cloning_6, aes(yintercept=Expected_additive_load/1000, colour = "GC_1E-6"))+
#	geom_linerange(data=filename_add_cloning, 
#			aes(x=GC_rate, 
#			    ymax=Cloning_add_max/1000, 
#			    ymin=Cloning_add_min/1000), color="darkolivegreen", size=1, 
