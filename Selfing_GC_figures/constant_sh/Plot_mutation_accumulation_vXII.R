...
colours <- c("Selfing"="black", "GC 1E-5"="purple", "GC 1E-6"="red", "GC 1E-7"="orange", "GC 1E-8"="yellow")
...
Cloning_recessive_load_all <- read.csv("/home/dvojkvietok/Documents/SlefingCloningGC/2_Cloning_with_gene_conversion/2_constant_sh/Model_december/Preliminary/Data_GC_recessive_load_vXII_test.csv")
Cloning_additive_load_all <- read.csv("/home/dvojkvietok/Documents/SlefingCloningGC/2_Cloning_with_gene_conversion/2_constant_sh//Model_december/Preliminary/Data_GC_additive_load_vXII_test.csv")
...
plot_name <- paste("Figure_Mutation_accumulation_selfing_vs_GC_", h_coefficient, "_vXII_test.png",sep="")
ggsave(filename=plot_name,
	plot=Plot,
	dpi=600)
	
plot_name <- paste("Figure_Mutation_accumulation_selfing_vs_GC_", h_coefficient, "v2_vXII_test.png",sep="")
ggsave(filename=plot_name,
	plot=Plot_2,
	dpi=600)
